...
public class DataModel {
	...
	public static Order[] createOrder(Item[] items, Customer[] customers) {
		...
		return new Order[] {
				new Order(customers[0], firstItemDetails ,LocalDateTime.of(2022, 5, 5, 10, 10, 20)),
